(self["webpackChunkhello_uniapp"] = self["webpackChunkhello_uniapp"] || []).push([[214],{
...
// load the styles
var content = __webpack_require__(77643);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(69333)/* ["default"] */ .A)
var update = add("a7a2381a", content, true, {"sourceMap":false,"shadowMode":false});
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof = (__webpack_require__(46750)["default"]);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* 文字基本颜色 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.infor[data-v-3eaa9999]{background-color:#f0f3f4;position:fixed;top:env(safe-area-inset-top); /* 兼容 iOS 11.0-11.4 */top:constant(safe-area-inset-top); /* 兼容 iOS 12.0-12.1 */touch-action:none;width:100%}.title[data-v-3eaa9999]{padding:0 0 5% 0;margin:0 0 5% 0;border-bottom:2px solid #f1f1f1;display:flex;align-items:center}.fields[data-v-3eaa9999]{background-color:#fff;border-radius:10px;margin:2.5% 5% 5% 5%;padding:5% 5% 1% 5%}.field[data-v-3eaa9999]{padding:0 0 15px 0;border-bottom:2px solid #f1f1f1;text-align:right}.field[data-v-3eaa9999]  .uni-forms-item__label{width:40%!important}.problem[data-v-3eaa9999]{background-color:#fff;border-radius:10px;margin:5%;height:18%;padding:5%}.yes[data-v-3eaa9999]{background-color:#e6f7ff;color:#2c99ff;border:1px solid #2c99ff;border-radius:6px;display:flex;width:15%;font-size:13px;text-align:center;justify-content:center;align-items:center}.save[data-v-3eaa9999]{background-color:#fff;justify-content:center;height:11%;position:fixed;bottom:0;width:100%}[data-v-3eaa9999] .u-transition .u-slide-up-enter-to .u-slide-up-enter-active{height:30%!important}[data-v-3eaa9999] .is-disabled{background-color:#fff!important}[data-v-3eaa9999] .uni-input-wrapper{text-align:right!important}", ""]);
// Exports
...
;// ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js??clonedRuleSet-42[0].rules[0].use[0]!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/filter-modules-template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/index.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-scoped-loader/index.js!./src/pages/task/checkItemsEdit.vue?vue&type=template&id=3eaa9999&scoped=true&
...
}}},[_c('uni-nav-bar',{staticStyle:{"background-color":"#ffffff","color":"black","font-weight":"bold"},attrs:{"shadow":true,"status-bar":true,"left-icon":"left","right-icon":"closeempty","title":"Check Items"},on:{"clickLeft":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.back).apply(void 0, arguments)
},"clickRight":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.back).apply(void 0, arguments)
}}}),_c('v-uni-scroll-view',{staticStyle:{"height":"75%","background-color":"#f1f4f5"},attrs:{"scroll-y":"true"}},[_c('v-uni-view',{staticClass:"fields"},[_c('v-uni-view',{staticClass:"title"},[_c('v-uni-view',{staticStyle:{"border-radius":"3px","background-color":"#038d10","width":"6px","height":"24px","margin-right":"3%"}}),_vm._v(" "+_vm._s(_vm.valiFormData.checkItems)+" ")],1),_c('uni-forms',{ref:"valiForm",attrs:{"rules":_vm.rules,"modelValue":_vm.valiFormData}},[_c('uni-forms-item',{staticClass:"field",attrs:{"required":_vm.required.upperStandardLimit,"label":"Upper Standard Limit","name":"upperStandardLimit"}},[_c('uni-easyinput',{attrs:{"disabled":_vm.disabled.upperStandardLimit,"placeholder":"/"},model:{value:(_vm.valiFormData.upperStandardLimit),callback:function ($$v) {_vm.$set(_vm.valiFormData, "upperStandardLimit", $$v)},expression:"valiFormData.upperStandardLimit"}})],1),_c('uni-forms-item',{staticClass:"field",attrs:{"label":"lowerStandardLimit","name":"Lower Standard Limit"}},[_c('uni-easyinput',{attrs:{"disabled":_vm.disabled.lowerStandardLimit,"placeholder":"/"},model:{value:(_vm.valiFormData.lowerStandardLimit),callback:function ($$v) {_vm.$set(_vm.valiFormData, "lowerStandardLimit", $$v)},expression:"valiFormData.lowerStandardLimit"}})],1),_c('uni-forms-item',{staticClass:"field",attrs:{"label":"Test Result","required":_vm.required.testResult,"name":"testResult"}},[_c('v-uni-picker',{attrs:{"disabled":_vm.disabled.testResult,"range":_vm.valiFormData.aekoId?_vm.measuredValueAekoList:_vm.measuredValueList,"range-key":"name"},on:{"change":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.selectMeasuredValue).apply(void 0, arguments)
}}},[_c('v-uni-view',{staticClass:"picker-inner",staticStyle:{"display":"flex","flex":"1 1","align-items":"center","border":"none"}},[(!_vm.valiFormData.testResult)?_c('v-uni-view',{staticClass:"picker-uni-input",staticStyle:{"color":"#999"}},[_c('v-uni-text',{staticStyle:{"color":"#999"}},[_vm._v("Please Select")])],1):_c('v-uni-view',{staticClass:"picker-uni-input"},[_c('v-uni-text',{staticStyle:{"color":"red"}},[_vm._v(_vm._s(_vm.valiFormData.testResult))])],1)],1)],1)],1),_c('uni-forms-item',{staticClass:"field",attrs:{"label":"Measured Value","name":"Actual Value"}},[_c('uni-easyinput',{attrs:{"type":"number","disabled":_vm.disabled.actualValue,"placeholder":"Please Input Actual Value"},on:{"input":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.inputAmount).apply(void 0, arguments)
}},model:{value:(_vm.valiFormData.actualValue),callback:function ($$v) {_vm.$set(_vm.valiFormData, "actualValue", $$v)},expression:"valiFormData.actualValue"}})],1)],1)],1),(_vm.valiFormData.testResult && _vm.valiFormData.testResult!='i.o')?_c('v-uni-view',{staticClass:"problem"},[_c('v-uni-view',{staticClass:"title"},[_c('v-uni-view',{staticStyle:{"border-radius":"3px","background-color":"#038d10","width":"6px","height":"24px","margin-right":"3%"}}),_vm._v(" Problem ")],1),_c('v-uni-view',{staticClass:"title",staticStyle:{"display":"flex","justify-content":"space-between","border":"none"}},[_c('v-uni-view',{staticStyle:{"display":"flex"}},[(_vm.valiFormData.testResult=='n.i.o')?_c('v-uni-view',{staticStyle:{"color":"red"}},[_vm._v("*")]):_vm._e(),_c('v-uni-view',[_vm._v("Input Problem")])],1),_c('v-uni-view',{staticClass:"yes",on:{"click":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.inputProblem).apply(void 0, arguments)
}}},[_vm._v("Yes")])],1)],1):_vm._e()],1),_c('v-uni-view',{staticClass:"save"},[_c('v-uni-view',{staticStyle:{"display":"flex","margin-top":"5%","justify-content":"center"}},[_c('v-uni-button',{staticStyle:{"background-color":"#e88173","width":"92%","margin":"0px 5px 5px 5px"},attrs:{"type":"primary","size":"default"},on:{"click":function($event){
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.Save).apply(void 0, arguments)
}}},[_vm._v("Save")])],1)],1)],1)}
var recyclableRender = false
var staticRenderFns = []


;// ./src/pages/task/checkItemsEdit.vue?vue&type=template&id=3eaa9999&scoped=true&
...
// EXTERNAL MODULE: ./src/common/js/jquery-3.5.1.min.js
var jquery_3_5_1_min = __webpack_require__(31930);
// EXTERNAL MODULE: ./src/common/luch-request/utils.js
var utils = __webpack_require__(88166);
;// ./src/static/js/formMixin.js
...
var formMixin = {
  ...
  methods: {
    getMeasuredValueList: function getMeasuredValueList() {
      var that = this;
      var data = [{
        id: "1",
        value: "i.o"
      ...
      that.measuredValueList = data.map(function (item) {
        var obj = {
          name: item.value,
          id: item.id
        };
    ...
    //Measured Value下拉选
    selectMeasuredValue: function selectMeasuredValue(e) {
      var that = this;
      //存id或者时存文本值
    ...
    cssStyle2DomStyle: function cssStyle2DomStyle(sName) {
      var reg = /[A-Z]/g;
      var retstr = "";
      for (var i in sName) {
        if (reg.test(sName[i])) {
    ...
    getFormat: function getFormat(date, fmt) {
      //author: meizz
      var phoneType = uni.getSystemInfoSync().platform;
      if (phoneType == 'ios') {
...
/* harmony default export */ var checkItemsEditvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      required: {
        testResult: true,
        upperStandardLimit: false,
        lowerStandardLimit: false,
        actualValue: false
      },
      disabled: {
        testResult: false,
        upperStandardLimit: true,
        lowerStandardLimit: true,
        actualValue: false
      },
      // 校验规则
      requiredArr: ['testResult'],
      rules: {
        testResult: {
          rules: [{
            required: true,
            errorMessage: 'Measured Value Cannot Be Empty'
          }]
        }
      },
      problemList: [],
  ...
  onLoad: function onLoad(e) {
    ...
    this.getMeasuredValueList();
    this.getMeasuredValueAekoList();
    if (e.data != undefined && e.data != null && e.data != null) {
      this.valiFormData = JSON.parse(decodeURIComponent(e.data));
      this.resultData = JSON.parse(e.resultData);
      this.scrollTop = e.scrollTop;
      // this.selectProblems = JSON.parse(e.selectProblems)
      this.getIsSelectProblem();
    }
  },
  watch: {},
  ...
  methods: {
    inputAmount: function inputAmount(value) {
      var _this = this;
      ...
      this.$nextTick(function () {
        _this.valiFormData.actualValue = val;
      });
    },
    getIsSelectProblem: function getIsSelectProblem() {
      var that = this;
      var params = {
      ...
      this.$http.get("/testService/qaTestProblem/appIsSelectProblem", {
        ...
        if (res.data.success) {
          if (res.data.result > 0) {
            that.isSelectProblem = true;
          } else {
            that.isSelectProblem = false;
          }
        }
      });
    },
    getMeasuredValueList: function getMeasuredValueList() {
      ...
      this.$http.get("/sys/dictItem/list", {
        ...
        if (res.data.success) {
          _this2.measuredValueList = res.data.result.records.map(function (item) {
    ...
    //获取Aeko项的 下拉选
    getMeasuredValueAekoList: function getMeasuredValueAekoList() {
      var _this3 = this;
      var params = {
      ...
      this.$http.get("/sys/dictItem/list", {
        ...
        if (res.data.success) {
          _this3.measuredValueAekoList = res.data.result.records.map(function (item) {
            return item.itemText;
          });
        }
      });
    ...
    selectMeasuredValue: function selectMeasuredValue(e) {
      if (this.valiFormData.aekoId) {
        this.valiFormData.testResult = this.measuredValueAekoList[e.detail.value];
      } else {
        this.valiFormData.testResult = this.measuredValueList[e.detail.value];
      }
      console.log(this.valiFormData.testResult);
      this.$forceUpdate();
      // this.$set(this.valiFormData, 'testResult', this.measuredValueList[e.detail.value])
    },
    inputProblem: function inputProblem() {
      uni.navigateTo({
        url: '../task/problemList?checkItemData=' + encodeURIComponent(JSON.stringify(this.valiFormData)) + '&resultData=' + JSON.stringify(this.resultData) + '&scrollTop=' + this.scrollTop
      });
    },
    back: function back() {
      uni.navigateBack();
    ...
    Save: function Save() {
      var _this4 = this;
      if (this.valiFormData.testResult == 'n.i.o' && !this.isSelectProblem) {
        uni.showToast({
          title: 'Please input problem',
          icon: 'none'
        });
      } else {
        //提交时间完成后 进行页面跳转
        ...
        this.$refs.valiForm.validateField(this.requiredArr).then(function (res) {
          ...
          _this4.handleBatchEdit(_this4.valiFormData.testResult, function (that) {
            //调用业务接口，新建或保存
            //跳转到新页面
            // uni.navigateBack();
            uni.navigateTo({
    ...
    handleBatchEdit: function handleBatchEdit(item, fun) {
      // valiFormData
      var that = this;
      var data = this.valiFormData;
      var arr = [];
      arr.push(data.id);
      var params = {
        ids: arr,
    ...
    getScreenHeight: function getScreenHeight() {
      ...
      uni.getSystemInfo({
        success: function success(res) {
          _this5.containerHeight = res.windowHeight + 'px';
        }
      });
    }
  }
...
var component = (0,componentNormalizer/* default */.A)(
  task_checkItemsEditvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var checkItemsEdit = (component.exports);
...
//# sourceMappingURL=pages-task-checkItemsEdit.50e8262a.js.map