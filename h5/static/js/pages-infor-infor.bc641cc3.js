...
arguments[0] = $event = _vm.$handleEvent($event);
(_vm.open).apply(void 0, arguments)
}},nativeOn:{"touchmove":function($event){$event.stopPropagation();$event.preventDefault();
arguments[0] = $event = _vm.$handleEvent($event);

}}},[_c('v-uni-view',{staticStyle:{"text-align":"center","padding":"15px","font-size":"16px"}},[_vm._v(_vm._s(_vm.popForm.titile))]),_c('v-uni-scroll-view',{staticStyle:{"height":"80% !important"},attrs:{"scroll-top":10,"scroll-y":"true"}},[_c('v-uni-view',{staticStyle:{"padding":"20rpx","height":"50%","margin-bottom":"10%"}},[_c('v-uni-view',{staticStyle:{"border-radius":"5px","padding":"3%","word-wrap":"break-word"}},[_vm._v(_vm._s(_vm.popForm.msgContent))])],1)],1)],1)],1)}
...
/* harmony default export */ var inforvue_type_script_lang_js_ = ({
  data: function data() {
    return {
      tip: '上拉加载更多',
      total: 0,
      imgPath: __webpack_require__(93357),
      messageList: [],
      tempMessageList: [],
      connected: false,
      connecting: false,
  ...
  methods: {
    ...
    closePopup: function closePopup(item) {
      var _this = this;
      //修改当前消息的读取状态
      //并重新渲染页面
      var postData = {
    ...
    getScreenHeight: function getScreenHeight() {
      ...
      uni.getSystemInfo({
        success: function success(res) {
          _this2.containerHeight = res.windowHeight + 'px';
          _this2.pageHeight = res.windowHeight * 0.93 + 'px';
          _this2.screenWidth = res.windowWidth + 'px';
        }
      });
    },
    getMessageList: function getMessageList(type) {
      ...
      this.$http.get(URL.list, {
        ...
        if (res.data.success) {
          if (type) {
            _this3.messageList = [].concat((0,toConsumableArray/* default */.A)(_this3.messageList), (0,toConsumableArray/* default */.A)(res.data.result.records));
          } else {
            _this3.messageList = res.data.result.records;
          }
          _this3.$store.dispatch('changeMessageNum', res.data.code);
          if (_this3.$store.state.messageNum > 0) {
            uni.setTabBarBadge({
              index: 1,
              text: _this3.$store.state.messageNum > 99 ? '99+' : _this3.$store.state.messageNum.toString()
            });
          } else {
            uni.removeTabBarBadge({
              index: 1
    ...
    scrolltolower: function scrolltolower(e) {
      ...
      if (that.messageList.length == that.total) {
        ...
        setTimeout(function () {
          // that.messageList = that.messageList.concat(that.tempMessageList)
          that.getMessageList("nextPage");
        }, 100);
      }
    },
    ...
    toggle: function toggle(type, item) {
      this.popForm = Object.assign({}, item);
      this.open(type);
    },
...
var component = (0,componentNormalizer/* default */.A)(
  infor_inforvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
"use strict";
module.exports = "data:image/png;base64,";
